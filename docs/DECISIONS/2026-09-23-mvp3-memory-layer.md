...
superseded-by: docs/DECISIONS/2026-09-24-log-redaction-profile-gate-cancellation.md (redaction doctrine: params broad, output narrow), docs/DECISIONS/2026-09-25-ledger-append-only-history-prune.md (ledger storage + budgets.ledger_chars semantics: append-only JSONL, retrieval-only budget, human-only prune)
---
